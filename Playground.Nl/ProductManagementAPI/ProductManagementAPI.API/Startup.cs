...
using Playground.Nl.ProductManagementAPI.API.Helpers;
using Playground.Nl.ProductManagementAPI.Database.Context;
using Playground.Nl.ProductManagementAPI.Services.Extensions;
using Playground.Nl.ProductManagementAPI.Services.Helpers;

namespace Playground.Nl.ProductManagementAPI.API
{
    public class Startup
    {
        private readonly IConfiguration _configuration;
        private readonly IWebHostEnvironment _env;
        private const string ConnectionStringName = "ProductManagementCN";
