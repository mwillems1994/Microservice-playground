...
using DiClassAttribute = Playground.Nl.OrderManagementAPI.Nl.Attributes.DiClassAttribute;
using DiSettingsAttribute = Playground.Nl.OrderManagementAPI.Nl.Attributes.DiSettingsAttribute;

namespace Playground.Nl.OrderManagementAPI.Nl.Extensions
{
